...
abstract class AppTheme {
  static final _darkColors = ColorsExtension(titleBarColor: AppPalette.avocado, buttonCornerRadius: 10);

  static final _lightColors = ColorsExtension(titleBarColor: AppPalette.avocadoLush, buttonCornerRadius: 5);
...
extension ThemeGetter on BuildContext {
  ...
  ColorsExtension get themeColorsExtension => Theme.of(this).extension<ColorsExtension>()!;
}
