...
import 'features/flipcards/domain/flipcards_repository.dart';
import 'features/flipcards/presentation/flipcard_details/cubit/flipcard_details_cubit.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiRepositoryProvider(
      ...
      child: MultiBlocProvider(
        providers: [
          BlocProvider<FlipcardsOverviewBloc>(create: (_) => FlipcardsOverviewBloc(_sampleItemsRepository)),
          BlocProvider<FlipcardDetailsCubit>(create: (_) => FlipcardDetailsCubit(_sampleItemsRepository)),
          BlocProvider<AppSettingsCubit>(create: (_) => AppSettingsCubit(_settingsRepository)..initialize()),
        ],
